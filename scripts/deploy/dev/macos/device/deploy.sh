...
setPlatform() {
  ...
  # >>>> MacOS - Network
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/macos/device/network/_hosts.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/macos/device/network/_hosts.sh
  else
    echo "Please check a file : ./scripts/deploy/dev/macos/device/network/_hosts.sh" && exit
  fi
  echo
  ...
  # >>>> MacOS - Security
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/macos/device/security/_users.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/macos/device/security/_users.sh
  else
    echo "Please check a file : ./scripts/deploy/dev/macos/device/security/_users.sh" && exit
  fi
  echo
