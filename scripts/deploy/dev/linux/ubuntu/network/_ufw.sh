...
if [ "${PLATFORM_TYPE}" == "Linux" ]; then
    ...
    if [ "${ENVIRONMENT_NAME}" == "dev" ]; then
      ...
      if [ "${UFW_STATUS}" != "active" ]; then
        ...
        # >>>> Private Network - Multicast
        sudo ufw deny from any to 239.255.255.250             # Multicast

        # --------------------------------------------------------------------------------------------------------------
        # UFW - service - Allow
        # --------------------------------------------------------------------------------------------------------------

        sudo ufw allow domain comment "DNS"                   # DNS
        sudo ufw allow ntp comment 'NTP'                      # NTP
        ...
        sudo ufw allow 8000/tcp comment 'Symfony Local server'

        sudo ufw allow 8001/tcp comment 'Symfony Local server - App 1'
        sudo ufw allow 8002/tcp comment 'Symfony Local server - App 2'
        sudo ufw allow 8003/tcp comment 'Symfony Local server - App 3'

        sudo ufw allow 8080/tcp comment 'Docker Container'

        sudo ufw allow 8081/tcp comment 'Docker Container - App 1'
        sudo ufw allow 8082/tcp comment 'Docker Container - App 2'
        sudo ufw allow 8083/tcp comment 'Docker Container - App 3'

        # >>>> Update allowed ports for Cache    - Redis
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 6379 proto tcp comment 'Redis'

        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 6381 proto tcp comment 'Redis - App 1'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 6382 proto tcp comment 'Redis - App 2'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 6383 proto tcp comment 'Redis - App 3'
        ...
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 5481 proto tcp comment 'PostgreSQL - App 1'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 5482 proto tcp comment 'PostgreSQL - App 2'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 5483 proto tcp comment 'PostgreSQL - App 3'
        ...
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 5681  proto tcp comment 'RabbitMQ - App 1'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 5682  proto tcp comment 'RabbitMQ - App 2'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 5683  proto tcp comment 'RabbitMQ - App 3'

        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 15681 proto tcp comment 'RabbitMQ - App 1 - http'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 15682 proto tcp comment 'RabbitMQ - App 2 - http'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 15683 proto tcp comment 'RabbitMQ - App 3 - http'

        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 4369  proto tcp comment 'RabbitMQ - clustering'
        ...
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 80 proto tcp  comment 'Nginx - HTTP'
        ...
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 5450 comment 'pgAdmin - Website'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 5451 comment 'pgAdmin - Website - App 1'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 5452 comment 'pgAdmin - Website - App 2'
        sudo ufw allow from 127.0.0.1 to 127.0.0.1 port 5453 comment 'pgAdmin - Website - App 3'
