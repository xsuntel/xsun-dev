...
setPlatform() {
  ...
  # >>>> Windows - Network
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/windows/device/network/_base.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/windows/device/network/_base.sh
  else
    echo "Please check a file : ./scripts/deploy/dev/windows/device/network/_base.sh" && exit
  fi
  echo

  # >>>> Windows - Packages
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/windows/device/packages/_base.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/windows/device/packages/_base.sh
  else
    echo "Please check a file : ./scripts/deploy/dev/windows/device/packages/_base.sh" && exit
  fi
  echo

  # >>>> Windows - Security
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/windows/device/security/_base.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/windows/device/security/_base.sh
  else
    echo "Please check a file : ./scripts/deploy/dev/windows/device/security/_base.sh" && exit
  fi
  echo
...
setPhp() {
  ...
  if [ -f "${PROJECT_PATH}"/scripts/base/app/symfony/_command.sh ]; then
    ...
    echo "Please check a file : ./scripts/base/app/symfony/_command.sh" && exit
  fi
  echo
  ...
  if [ -f "${PROJECT_PATH}"/scripts/base/app/symfony/_components.sh ]; then
    ...
    echo "Please check a file : ./scripts/base/app/symfony/_components.sh" && exit
  fi
  echo
}
...
setBuild() {
  ...
  if [ -f "${PROJECT_PATH}/scripts/base/app/symfony/_deployment.sh" ]; then
    ...
    echo "Please check a file : ./scripts/base/app/symfony/_deployment.sh" && exit
  fi
  echo
  ...
  #else
  #  echo "Please check a file : ./scripts/base/app/symfony/front-end/_assetmapper.sh" && exit
  #fi
  #echo
  ...
  #else
  #  echo "Please check a file : ./scripts/base/app/symfony/front-end/_webpack.sh" && exit
  #fi
  #echo
}
...
setUtility() {
  ...
  if [ -f "${PROJECT_PATH}"/scripts/base/app/symfony/_local_server.sh ]; then
    ...
    echo "Please check a file : ./scripts/base/app/symfony/_local_server.sh" && exit
  fi
  echo
}
